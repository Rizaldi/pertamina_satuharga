            ...
            <div class="col-xl-12 dahsboard-column">
                <section class="box-typical box-typical-dashboard panel x-ua-compatible scrollable">
                    <header class="box-typical-header panel-heading">
                        <h3 class="panel-title">Report Stok Harian
...
//        });
        ...
        $("#filter_datatable_satuharga").on("click", function (e) {
                ...
                var url_param_dt = `http://ptmsolar.com/api_pertamina/apix_satuharga/api_report/get_report_stok_harian/`;
